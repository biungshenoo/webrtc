...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1582380029);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1582029899);
user_pref("browser.laterrun.bookkeeping.sessionCount", 4);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 68);
user_pref("browser.newtabpage.activity-stream.impressionId", "{87ff7968-3b86-4063-be32-b15b08708e20}");
user_pref("browser.newtabpage.activity-stream.migrationExpired", true);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1581955200);
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1582465176");
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1582380011403");
...
user_pref("extensions.webextensions.uuids", "{\"webcompat@mozilla.org\":\"27dac3d5-64d5-4b0d-ae82-97d4632bcd6d\",\"screenshots@mozilla.org\":\"254be00b-a436-4205-b4c6-963e9e06f469\"}");
user_pref("lightweightThemes.usedThemes", "[]");
user_pref("media.gmp-manager.buildID", "20180704194937");
user_pref("media.gmp-manager.lastCheck", 1582380025);
...
user_pref("security.sandbox.content.tempDirSuffix", "8ceb40ef-ba9c-4571-9659-f7c4a4e6e3e0");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1582465170);
user_pref("toolkit.telemetry.cachedClientID", "5a381c98-c229-42b9-883b-5e32ab270cea");
